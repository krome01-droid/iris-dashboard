<?php
/**
 * IRIS Dashboard — MySQL Proxy via WP REST API
 *
 * Ce fichier se place dans wp-content/mu-plugins/ sur o2switch.
 * Il enregistre un endpoint WP REST API sécurisé accessible via :
 *   POST https://autoecole-inris.com/wp-json/iris/v1/db
 *
 * Auth : header  X-Iris-Secret: <token>
 */

if (!defined('ABSPATH')) exit;

add_action('rest_api_init', function () {
    register_rest_route('iris/v1', '/db', [
        'methods'             => ['POST', 'OPTIONS'],
        'callback'            => 'iris_db_proxy_handler',
        'permission_callback' => '__return_true', // Auth gérée dans le callback
    ]);
});

function iris_db_proxy_handler(WP_REST_Request $request): WP_REST_Response|WP_Error {
    $expected_secret = '48ff093220fd94b5bc2603ac517f2c29fe1e3aaccd275d44';
    $provided_secret = $request->get_header('X-Iris-Secret');
    ...
    switch ($action) {
        ...
        case 'migrate':
            ...
            $sqls = [
                "CREATE TABLE IF NOT EXISTS {$prefix}iris_content_log (
                    ...
                    created_by VARCHAR(100) DEFAULT 'iris',
                ...
                "CREATE TABLE IF NOT EXISTS {$prefix}iris_social_posts (
                    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
                ...
                "CREATE TABLE IF NOT EXISTS {$prefix}iris_seo_reports (
                    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
                ...
                "CREATE TABLE IF NOT EXISTS {$prefix}iris_editorial_calendar (
                    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
                    title VARCHAR(500) NOT NULL,
                    ...
                    assigned_to VARCHAR(100) DEFAULT 'iris',
                    content_log_id BIGINT UNSIGNED DEFAULT NULL,
                ...
                "CREATE TABLE IF NOT EXISTS {$prefix}iris_conversations (
                    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
                ...
                "CREATE TABLE IF NOT EXISTS {$prefix}iris_collaborators (
                    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
            ...
            $alter = "ALTER TABLE {$prefix}iris_content_log
            ...
            $tables_created[] = $res === false
                ...
                : "OK: ALTER {$prefix}iris_content_log.type ENUM";
