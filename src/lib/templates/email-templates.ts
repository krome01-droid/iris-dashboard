// ─── Charte graphique autoecole-inris.com ────────────────────────
  ...
  <tr>
    <td align="center" style="padding: 28px 20px;">
      ...
      <div style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #8B92A8; line-height: 1.8;">
        <a href="https://autoecole-inris.com" style="color: #C73B2A; text-decoration: none;">autoecole-inris.com</a>
        &nbsp;·&nbsp; Le comparateur de 9 800+ auto-écoles en France<br>
        contact@autoecole-inris.com<br><br>
        <span style="font-size: 11px; color: #555E7A;">
          Vous recevez cet email car vous êtes inscrit(e) sur autoecole-inris.com.<br>
  ...
  <tr>
    <td align="center" style="padding: 28px 20px;">
      ...
      <div style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #555E7A; line-height: 1.8;">
        <a href="https://autoecole-inris.com" style="color: #C73B2A; text-decoration: none;">autoecole-inris.com</a>
        &nbsp;·&nbsp; contact@autoecole-inris.com<br>
...
<head>
  ...
  <title>autoecole-inris.com</title>
</head>
...
export const EMAIL_TEMPLATES: Record<TemplateName, EmailTemplate> = {
  ...
  newsletter_hebdomadaire: {
    ...
    subject_example: "Permis, actus, conseils — votre newsletter Auto-École INRI'S",
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Newsletter — Auto-École INRI'S</title>
    <style type="text/css">
        #outlook a { padding: 0; }
...
<body style="background-color: #f4f4f5; margin: 0; padding: 0; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #1a1c1c;">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="background-color: #fdf2f4; border-left: 4px solid #e31e44; border-radius: 0 6px 6px 0; padding: 18px 20px;">
                                    ...
                                    <a href="https://autoecole-inris.com/recherche-auto-ecoles/" target="_blank" style="font-size: 14px; font-family: Arial, sans-serif; color: #e31e44; text-decoration: none; font-weight: bold;"><!--[if mso]><font color="#e31e44"><![endif]-->Trouver mon auto-école &rarr;<!--[if mso]></font><![endif]--></a>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td align="center" style="background-color: #1a1c1c; padding: 25px 40px;">
                        <p style="margin: 0 0 10px 0; font-size: 14px; font-family: Arial, sans-serif;">
                            <a href="https://autoecole-inris.com" style="color: #ffffff; text-decoration: none; margin: 0 8px;"><!--[if mso]><font color="#ffffff"><![endif]-->Notre site<!--[if mso]></font><![endif]--></a>
                            <span style="color: #555555;">|</span>
                            <a href="https://autoecole-inris.com/blog-accueil/" style="color: #ffffff; text-decoration: none; margin: 0 8px;"><!--[if mso]><font color="#ffffff"><![endif]-->Blog<!--[if mso]></font><![endif]--></a>
                            <span style="color: #555555;">|</span>
                            <a href="https://autoecole-inris.com/contact/" style="color: #ffffff; text-decoration: none; margin: 0 8px;"><!--[if mso]><font color="#ffffff"><![endif]-->Contact<!--[if mso]></font><![endif]--></a>
                            <span style="color: #555555;">|</span>
                        ...
                        <p style="margin: 0; font-size: 12px; color: #888888; line-height: 1.5; font-family: Arial, sans-serif;">
                            &copy; 2026 Auto-École INRI'S. Tous droits réservés.
                        </p>
                    </td>
                </tr>
  ...
  bienvenue: {
    ...
    subject_example: "Bienvenue sur autoecole-inris.com 👋",
        ...
        <tr>
          <td align="center" style="padding: 36px 32px 20px;">
            ...
            <div style="font-family: Georgia, serif; font-size: 26px; font-weight: bold; color: #1A1D2E; line-height: 1.3;">
              Bienvenue sur<br>autoecole-inris.com
            </div>
          </td>
        </tr>
      </table>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="padding: 0 32px 24px; font-family: Arial, sans-serif; font-size: 15px; color: #555555; line-height: 1.8;">
            ...
            Merci de rejoindre la communauté autoecole-inris.com — le site de référence pour préparer votre permis de conduire en France.<br><br>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td align="center" style="padding: 0 32px 12px;">
            <a href="https://autoecole-inris.com/comparateur" style="display: inline-block; background-color: #C73B2A; color: #FFFFFF; font-family: Arial, sans-serif; font-size: 14px; font-weight: bold; text-decoration: none; padding: 14px 28px; border-radius: 4px; width: 240px; text-align: center;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td align="center" style="padding: 8px 32px 32px;">
            <a href="https://autoecole-inris.com/guides" style="font-family: Arial, sans-serif; font-size: 13px; color: #C73B2A; text-decoration: none;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="padding: 32px 32px 16px; font-family: Arial, sans-serif; font-size: 15px; color: #555555; line-height: 1.8;">
            Bonjour {{contact.first_name}},<br><br>
            Hier, vous avez rejoint autoecole-inris.com. Aujourd'hui, je vous partage quelque chose d'utile.
          </td>
        </tr>
      </table>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="padding: 0 32px 20px; font-family: Arial, sans-serif; font-size: 14px; color: #333333; line-height: 1.9;">
            Bonjour,<br><br>
            autoecole-inris.com est le comparateur de référence pour les 17-25 ans qui cherchent une auto-école à <strong>{{ville}}</strong>. Chaque mois, des milliers de candidats consultent notre plateforme avant de prendre leur décision.<br><br>
  ...
  b2b_partenariat: {
    ...
    subject_example: "Collaboration éditoriale — autoecole-inris.com × {{nom_partenaire}}",
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="padding: 0 32px 24px; font-family: Arial, sans-serif; font-size: 14px; color: #333333; line-height: 1.9;">
            ...
            Je suis Laurent, éditeur d'autoecole-inris.com — le comparateur de référence pour les candidats au permis de conduire en France (9 800+ auto-écoles, 50 000+ visiteurs/mois).<br><br>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="padding: 36px 32px; font-family: Arial, sans-serif; font-size: 15px; color: #333333; line-height: 1.9;">
            ...
            Je me permets de revenir vers vous concernant le référencement de <strong>{{nom_autoecole}}</strong> sur autoecole-inris.com.<br><br>
        ...
        <tr>
          <td style="padding: 0 32px 36px;">
            ...
            <span style="display: inline-block; margin-left: 16px; font-family: Arial, sans-serif; font-size: 13px; color: #8B92A8; line-height: 44px;">
              Cordialement, Laurent — autoecole-inris.com
            </span>
          </td>
        </tr>
      </table>
