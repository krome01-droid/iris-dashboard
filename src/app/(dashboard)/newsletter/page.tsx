...
const EMAIL_TEMPLATES = [
  {
    ...
    subject: "Auto-École INRI'S - Les actus de la semaine",
  ...
  <div style="padding:20px;">
    ...
    <p style="text-align:center;margin-top:20px;">
      <a href="https://autoecole-inris.com" style="background:#dc2626;color:white;padding:12px 24px;text-decoration:none;border-radius:6px;">Lire sur le site</a>
    </p>
  </div>
  <div style="background:#f3f4f6;padding:12px;text-align:center;font-size:12px;color:#6b7280;">
    autoecole-inris.com - Le comparateur d'auto-ecoles
  </div>
</div>`,
  },
  {
  ...
  <div style="padding:20px;">
    ...
    <p style="text-align:center;margin-top:20px;">
      <a href="https://autoecole-inris.com" style="background:#dc2626;color:white;padding:12px 24px;text-decoration:none;border-radius:6px;">Decouvrir le guide</a>
    </p>
  </div>
</div>`,
  },
...
export default function NewsletterPage() {
  ...
  const sendEmail = async (mode: "preview" | "send_all") => {
    ...
    try {
      const res = await fetch("/admin-iris/api/ghl/email", {
        method: "POST",
                ...
                <Card>
                  <CardContent className="p-4">
                    <p className="text-sm text-muted-foreground">
                      Vous pouvez aussi demander a IRIS de rediger votre newsletter.
                    </p>
