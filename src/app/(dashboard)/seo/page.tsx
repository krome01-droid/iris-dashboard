  ...
  const fetchSeoData = useCallback(async () => {
    ...
    try {
      ...
      const [kwRes, auditRes, recoRes] = await Promise.all([
        fetch("/admin-iris/api/seo/search-console?type=keywords", { signal: ctrl.signal }),
        fetch("/admin-iris/api/seo/audit?type=audit", { signal: ctrl.signal }),
        fetch("/admin-iris/api/seo/audit?type=recommendations", { signal: ctrl.signal }),
      ])
            ...
            <Card className="mt-4">
              ...
              <CardContent>
                {data.issues.length === 0 ? (
                  <p className="text-sm text-muted-foreground">Aucun probleme detecte. Lancez un audit via IRIS pour une analyse complete.</p>
                ) : (
            ...
            <Card className="mt-4">
              ...
              <CardContent>
                {data.recommendations.length === 0 ? (
                  <p className="text-sm text-muted-foreground">Lancez un audit SEO via IRIS pour obtenir des recommandations personnalisees.</p>
                ) : (
                ...
                <div className="mt-4 pt-4 border-t">
                  <p className="text-sm text-muted-foreground">
                    Demandez a IRIS de generer un audit SEO complet ou de rediger du contenu optimise.
                  </p>
          ...
          <TabsContent value="geo">
            <Card className="mt-4">
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Le SEO local est essentiel pour autoecole-inris.com — les recherches &quot;auto-ecole + ville&quot;
                ...
                <div className="pt-3 border-t">
                  <p className="text-sm text-muted-foreground">
                    Demandez a IRIS de creer les pages villes manquantes pour capter ce trafic.
                  </p>
                  <Button className="mt-2" size="sm" variant="outline" render={<Link href="/chat" />}>
